    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {isLoading ? (
            <div className="bg-gradient-to-br rounded-2xl p-8 text-center text-white shadow-2xl" style={{background: 'linear-gradient(135deg, #0033A0, #C8102E)'}}>
            ...
            <div className="bg-gradient-to-br rounded-2xl p-8 text-center text-white shadow-2xl relative" style={{background: 'linear-gradient(135deg, #0033A0, #C8102E)'}}>
